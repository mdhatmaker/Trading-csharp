...
{
    public enum FillAction { ADD = 0, AMEND = 1, DELETE = 2 };
    public enum FillOriginator { TRADER = 0, ADMIN = 1 };
    ...
    public class InstrumentInfo
    {
        ...
        public string InstrumentDescriptor { get; set; }
        public ProductKey ProductKey { get; set; }
        public string Contract { get; set; }
        public Price BidPrice { get; set; }
        public Price AskPrice { get; set; }
        ...
        public InstrumentInfo(string descriptor)
        {
            InstrumentDescriptor = descriptor;
        }

        public InstrumentInfo(InstrumentKey key)
        {
            InstrumentKey = key;
        ...
        public override bool Equals(object obj)
        {
            ...
            InstrumentInfo compareObject = obj as InstrumentInfo;
            ...
            {
                result = (compareObject.InstrumentKey == this.InstrumentKey);
            }
